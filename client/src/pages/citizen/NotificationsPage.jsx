...
import { Bell, CheckCheck, Trash2, Info, AlertCircle, CheckCircle, Star } from 'lucide-react';
...
const typeIcon = (type) => {
  switch (type) {
    ...
    case 'issue_assigned': return <Info className="w-5 h-5 text-blue-500" />;
    case 'issue_resolved': return <Star className="w-5 h-5 text-yellow-500" />;
