...
import { Bell, CheckCheck, Trash2, Info, AlertCircle, CheckCircle, Star, UserCheck, UserX } from 'lucide-react';
...
const typeIcon = (type) => {
  switch (type) {
    case 'issue_submitted': return <Info className="w-5 h-5 text-blue-500" />;
    case 'resolution_uploaded': return <CheckCircle className="w-5 h-5 text-green-500" />;
    case 'issue_in_progress': return <CheckCircle className="w-5 h-5 text-green-500" />;
    case 'issue_assigned': return <UserCheck className="w-5 h-5 text-purple-500" />;
    case 'issue_rejected': return <UserX className="w-5 h-5 text-red-500" />;
    case 'auto_assigned': return <Star className="w-5 h-5 text-yellow-500" />;
